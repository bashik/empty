...
class YiiBase
{
	...
	/**
	 * Returns a string that can be displayed on your Web pages showing Powered-by-Yii information
	 * @return string a string that can be displayed on your Web pages showing Powered-by-Yii information
	 */
