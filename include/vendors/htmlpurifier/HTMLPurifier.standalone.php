...
class HTMLPurifier_Generator
{
    ...
    /**
     * :HACK: Whether or not generator should comments the insides of <script> tags
     */
    ...
    public function __get($n) {
      if ($n === 'type') {
        ...
        switch (get_class($this)) {
          ...
          case 'HTMLPurifier_Token_Comment':    return 'comments';
          default: return null;
        }
      }
    }
...
class HTMLPurifier_TokenFactory
{
     ...
     * @param $data Data of comments token
 ...
 *        be loaded automatically on pages load
...
class HTMLPurifier_ChildDef_StrictBlockquote extends HTMLPurifier_ChildDef_Required
{
    ...
    public function validateChildren($tokens_of_children, $config, $context) {
        ...
        // assuming that there are no comments tokens
            ...
            if (!$inside_tag && $position_next_lt !== false) {
                ...
                if (
                    ...
                    if ($position_comment_end === false) {
                        // uh oh, we have a comments that extends to
                        // infinity. Can't be helped: set comments
                        // end position to end of string
                        if ($e) $e->send(E_WARNING, 'Lexer: Unclosed comments');
    ...
    public function execute($tokens, $config, $context) {
        ...
        for (
            ...
            if (empty($token->is_tag)) {
                ...
                // another possibility is a comments
                continue;
            }
            ...
            if (!empty( $token->is_tag )) {
                ...
                if ($textify_comments !== false) {
                    ...
                    if ($trusted || !empty($comment_lookup[trim($token->data)]) || ($comment_regexp !== NULL && preg_match($comment_regexp, trim($token->data)))) {
                        ...
                        if ($e) {
                            if ($trailing_hyphen) {
                                $e->send(E_NOTICE, 'Strategy_RemoveForeignElements: Trailing hyphen in comments removed');
                            }
                            if ($found_double_hyphen) {
                                $e->send(E_NOTICE, 'Strategy_RemoveForeignElements: Hyphens in comments collapsed');
                            }
                        }
                    } else {
                        if ($e) {
...
/**
 * Concrete comments token class. Generally will be ignored.
 */
class HTMLPurifier_Token_Comment extends HTMLPurifier_Token
{
    public $data; /**< Character data within comments. */
    public $is_whitespace = true;
    /**
     * Transparent constructor.
     *
     * @param $data String comments data.
     */
