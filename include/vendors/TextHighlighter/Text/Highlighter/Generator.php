...
class Text_Highlighter_Generator extends  XML_Parser
{
    ...
    */
    ...
    /**
    * Character data handler. Used for comments
    */
    ...
    /**
    * start handler for <comments> element
    */
    ...
    */
    ...
    /**
    * end handler for <comments> element
    */
...
* tab-width: 4
* c-basic-offset: 4
* c-hanging-comments-ender-p: nil
* End:
*/
