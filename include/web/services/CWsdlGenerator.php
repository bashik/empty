 ...
 * In particular, it recognizes the '@soap' tag in the comments and extracts
 * API method and type definitions.
 *
 * In a service class, a remote invokable method must be a public method with a doc
 * comments block containing the '@soap' tag. In the doc comments, the type and name
 ...
 * are considered, and they each must be associated with a doc comments block containg
 * the '@soap' tag. The doc comments block should declare the type of the property.
 *
