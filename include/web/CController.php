 ...
 * @property string $pageTitle The pages title. Defaults to the controller name and the action name.
...
{
	/**
	 * Name of the hidden field storing persistent pages states.
	 */
	 ...
	 * This method may also save the persistent pages states in hidden fields of
	 * stateful forms in the pages.
	...
	public function processOutput($output)
	{
		...
		// if using pages caching, we should delay dynamic output replacement
	...
	/**
	 * @return string the pages title. Defaults to the controller name and the action name.
	 */
	...
	/**
	 * @param string $value the pages title.
	 */
	...
	/**
	 * Returns a persistent pages state value.
	 * A pages state is a variable that is persistent across POST requests of the same pages.
	 * In order to use persistent pages states, the form(s) must be stateful
	 ...
	 * @return mixed the pages state value
	 * @see setPageState
	...
	/**
	 * Saves a persistent pages state value.
	 * A pages state is a variable that is persistent across POST requests of the same pages.
	 * In order to use persistent pages states, the form(s) must be stateful
	 * which are generated using {@link CHtml::statefulForm}.
	 * @param string $name the state name
	 * @param mixed $value the pages state value
	 * @param mixed $defaultValue the default pages state value. If this is the same as
	...
	/**
	 * Loads pages states from a hidden input.
	 * @return array the loaded pages states
	 */
	...
	/**
	 * Saves pages states as a base64 string.
