 ...
 *
 * CDataProviderIterator iterates over the results of a data provider, starting at the first pages
 * of results and ending at the last pages. It is usually only suited for use with {@link CActiveDataProvider}.
 *
...
class CDataProviderIterator extends CComponent implements Iterator, Countable
{
	...
	/**
	 * Loads a pages of items
	 * @return array the items from the next pages of results
	 */
