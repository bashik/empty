...
class CListPager extends CBasePager
{
	...
	public $promptText;
	/**
	 * @var string the format string used to generate pages selection text.
	...
	/**
	 * Generates the list option for the specified pages number.
	 * You may override this method to customize the option display.
	 * @param integer $page zero-based pages number
	 * @return string the list option for the pages number
	 */
