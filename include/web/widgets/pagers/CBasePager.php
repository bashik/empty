 ...
 *
 * It provides the calculation of pages count and maintains the current pages.
 *
 * @property CPagination $pages The pagination information.
 * @property integer $pageSize Number of items in each pages.
...
abstract class CBasePager extends CWidget
{
	...
	/**
	 * @return integer number of items in each pages.
	 ...
	 * @param integer $page the pages that the URL should point to.
