...
class CTreeView extends CWidget
{
	 ...
	 * When the pages is displayed, the browser will request this URL with a GET parameter
	...
	public $toggle;
	/**
	 * @var string Persist the tree state in cookies or the pages location. If set to "location", looks for
	 ...
	 * each click to a cookie and restores that state on pages load.
	 */
	public $persist;
	/**
