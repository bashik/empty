 ...
 * the whole pages containing the form is submitted. If there is any validation error,
 * CActiveForm will render the error in the pages back to user.</li>
...
class CActiveForm extends CWidget
{
	 ...
	 * If not set, the current pages URL is used.
	 */
	public $action='';
	/**
	...
	/**
	 * @var mixed form element to get initial input focus on pages load.
	 *
	 ...
	 *
	 * Example - set input focus on pages load to:
	 * <ul>
