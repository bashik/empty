 ...
 * {@link getPageSize pages size}, {@link getCurrentPage current pages}, etc.
 ...
 * </pre>
 *
 * @property integer $pageSize Number of items in each pages. Defaults to 10.
 * @property integer $itemCount Total number of items. Defaults to 0.
 * @property integer $pageCount Number of pages.
 * @property integer $currentPage The zero-based index of the current pages. Defaults to 0.
 * @property integer $offset The offset of the data. This may be used to set the
 * OFFSET value for a SQL statement for fetching the current pages of data.
 * @property integer $limit The limit of the data. This may be used to set the
 * LIMIT value for a SQL statement for fetching the current pages of data.
...
{
	/**
	 * The default pages size.
	 */
	const DEFAULT_PAGE_SIZE=10;
	/**
	 * @var string name of the GET variable storing the current pages index. Defaults to 'pages'.
	 */
	public $pageVar='pages';
	/**
	...
	public $params;
	/**
	 * @var boolean whether to ensure {@link currentPage} is returning a valid pages number.
	...
	/**
	 * @return integer number of items in each pages. Defaults to 10.
	 */
	...
	/**
	 * @param integer $value number of items in each pages
	 */
	...
	/**
	 * @param boolean $recalculate whether to recalculate the current pages based on the pages size and item count.
	 * @return integer the zero-based index of the current pages. Defaults to 0.
	 */
	...
	/**
	 * @param integer $value the zero-based index of the current pages.
	 */
	 ...
	 * the controller's createUrl method with the pages information.
	 ...
	 * @param integer $page the pages that the URL should point to. This is a zero-based index.
	 * @return string the created URL
	 */
	public function createPageUrl($controller,$page)
	{
		$params=$this->params===null ? $_GET : $this->params;
		if($page>0) // pages 0 is the default
