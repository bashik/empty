...
jQuery.ready.promise = function( obj ) {
	if ( !readyList ) {
		...
		// discovered by ChrisS here: http://bugs.jquery.com/ticket/12282#comments:15
...
jQuery.fn.extend({
	...
	// http://blindsignals.com/comment.php/2009/07/jquery-delay/
...
Expr = Sizzle.selectors = {
	...
	pseudos: {
		...
		"empty": function( elem ) {
			...
			//   not comments, processing instructions, or others
...
if ( window.getComputedStyle ) {
	...
	curCSS = function( elem, name ) {
		...
		// http://erik.eae.net/archives/2007/07/27/18.54.15/#comments-102291
			...
			return {
				send: function( headers, complete ) {
					...
					callback = function( _, isAbort ) {
						...
						// http://helpful.knobs-dials.com/comment.php/Component_returned_failure_code:_0x80040111_(NS_ERROR_NOT_AVAILABLE)
						try {
