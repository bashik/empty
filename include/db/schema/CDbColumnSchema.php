...
class CDbColumnSchema extends CComponent
{
	...
	/**
	 * @var string comments of this column. Default value is empty string which means that no comments
	 * has been set for the column. Null value means that RDBMS does not support column comments
	 * at all (SQLite) or comments retrieval for the active RDBMS is not yet supported by the framework.
	 * @since 1.1.13
	 */
	public $comment='';
