...
EOD;
	...
	{
		$fileList['comment.php']['callback']=array($this,'generateIndex');
	...
	/**
	 * Inserts path to framework's yii.php into application's comment.php
	 *
	...
	public function generateIndex($source,$params)
	{
		...
		$yii=$this->getRelativePath($yii,$this->_rootPath.DIRECTORY_SEPARATOR.'comment.php');
		$yii=str_replace('\\','\\\\',$yii);
