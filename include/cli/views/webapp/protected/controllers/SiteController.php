...
class SiteController extends Controller
{
	...
	public function actions()
	{
		return array(
			...
			// They can be accessed via: comment.php?r=site/pages&view=FileName
			'pages'=>array(
				'class'=>'CViewAction',
			),
		);
	...
	{
		// renders the view file 'protected/views/site/comment.php'
