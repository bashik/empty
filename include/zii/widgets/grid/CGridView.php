 ...
 * and pagination can be done in AJAX mode or normal pages request. A benefit of using CGridView is that
 * when the user browser disables JavaScript, the sorting and pagination automatically degenerate
 * to normal pages requests and are still functioning as expected.
 *
...
class CGridView extends CBaseListView
{
	 ...
	 * If it is set false, it means sorting and pagination will be performed in normal pages requests
	 ...
	 * These tokens are recognized: {pages} and {sort}. They will be replaced with the pagination and sorting links selectors.
	 * Defaults to '{pages}, {sort}', that means that the pagination links and the sorting links will trigger AJAX updates.
	 ...
	 * <pre>
	 *  ...
	 *  'updateSelector'=>'{pages}, {sort}, #mybutton',
	 *  ...
	 * </pre>
	 * @since 1.1.7
	 */
	public $updateSelector='{pages}, {sort}';
	/**
	 ...
	 * called on this property. If not set, the current pages URL will be used for AJAX requests.
	 * @since 1.1.8
	 */
	public $ajaxUrl;
	/**
	 ...
	 * CSS file. If this is set false, you are responsible to explicitly include the necessary CSS file in your pages.
	 */
	public $cssFile;
	/**
	 ...
	 * to persist state of grid across pages revisits.  Note, there are two limitations for this feature:
	 * <ul>
	 *    <li>this feature is only compatible with browsers that support HTML5.</li>
	 *    <li>expect unexpected functionality (e.g. multiple ajax calls) if there is more than one grid/list on a single pages with enableHistory turned on.</li>
	 * </ul>
	 * @since 1.1.11
	 */
