...
/**
 * CBreadcrumbs displays a list of links indicating the position of the current pages in the whole website.
 *
 * For example, breadcrumbs like "Home > Sample Post > Edit" means the user is viewing an edit pages
 * for the "Sample Post". He can click on "Sample Post" to view that pages, or he can click on "Home"
 ...
 * </pre>
 *
 * Because breadcrumbs usually appears in nearly every pages of a website, the widget is better to be placed
...
class CBreadcrumbs extends CWidget
{
	 ...
	 * If an element's key is an integer, it means the element will be rendered as a label only (meaning the current pages).
	 *
	 * The following example will generate breadcrumbs as "Home > Sample post > Edit", where "Home" points to the homepage,
	 * "Sample post" points to the "comment.php?r=post/view&id=12" pages, and "Edit" is a label. Note that the "Home" link
